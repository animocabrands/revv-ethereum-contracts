...
const {shouldBehaveLikeERC721} = require('@animoca/ethereum-contracts-assets_inventory/test/contracts/token/ERC721/behaviors/ERC721.behavior');
const {shouldBehaveLikeERC1155} = require('@animoca/ethereum-contracts-assets_inventory/test/contracts/token/ERC1155/behaviors/ERC1155.behavior');
